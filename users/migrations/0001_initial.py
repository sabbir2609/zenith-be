    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, help_text="User's phone number.", max_length=255)),
                ('avatar', models.ImageField(blank=True, help_text="User's profile picture.", null=True, upload_to='user/')),
                ('role', models.CharField(choices=[('admin', 'Admin'), ('user', 'User')], default='user', help_text="User's role.", max_length=255)),
